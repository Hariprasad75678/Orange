...
public static String readProperty(String property) {
	try {
		f=new FileInputStream(FrameworkConstants.PROPERTYFILEPATH);
...
public static void selectValuefromDrop(WebElement ele, String value) {
	List<WebElement> items=ele.findElement(By.tagName("span"));
...
public boolean isElementsAvailable(List<WebElement> ele) {
	if(ele.size()>0)
		return true;
	else
		return false;
